...
Notes:
    ...
    cd ~/code/ibeis/tpl/guitool_ibeis
    mkdir -p docs
    cd docs
    ...
    rm -rf ~/code/ibeis/tpl/guitool_ibeis/docs/source/auto
    cd ~/code/ibeis/tpl/guitool_ibeis/docs
    sphinx-apidoc --private --separate --force --output-dir ~/code/ibeis/tpl/guitool_ibeis/docs/source/auto ~/code/ibeis/tpl/guitool_ibeis/guitool_ibeis
    ...
    Also:
        ...
        https://readthedocs.org/dashboard/guitool-ibeis/advanced/
        ...
        Enter the following information:
            Set the Repository NAME: guitool_ibeis
            Set the Repository URL: https://github.com/Erotemic/guitool_ibeis

        Make sure you have a .readthedocs.yml file

        For gitlab you also need to setup an integrations. Navigate to:

            https://readthedocs.org/dashboard/guitool-ibeis/integrations/create/
        ...
        Then go to
            ...
            https://github.com/Erotemic/guitool_ibeis/hooks
        ...
        Will also need to activate the main branch:
            https://readthedocs.org/projects/guitool-ibeis/versions/
"""
#
...
project = 'guitool_ibeis'
copyright = '2026, Jon Crall'
author = 'Jon Crall'
modname = 'guitool_ibeis'

repo_dpath = dirname(dirname(dirname(__file__)))
mod_dpath = join(repo_dpath, 'guitool_ibeis')
...
# html_logo = '.static/guitool_ibeis.svg'
# html_favicon = '.static/guitool_ibeis.ico'
...
man_pages = [
    (master_doc, 'guitool_ibeis', 'guitool_ibeis Documentation', [author], 1)
]
