...
Notes:
    ...
    cd ~/code/guitool_ibeis/docs
    sphinx-apidoc --private --separate -f -o ~/code/guitool_ibeis/docs/source/auto ~/code/guitool_ibeis/guitool_ibeis
...
latex_documents = [
    (master_doc, 'guitool_ibeis.tex', 'guitool_ibeis Documentation',
     'Jon Crall', 'manual'),
]
...
man_pages = [
    (master_doc, 'guitool_ibeis', 'guitool_ibeis Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'guitool_ibeis', 'guitool_ibeis Documentation',
     author, 'guitool_ibeis', 'One line description of project.',
     'Miscellaneous'),
]
