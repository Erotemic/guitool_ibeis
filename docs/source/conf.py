...
Notes:
    ...
    sphinx-apidoc -f -o ~/code/guitool_ibeis/docs/source ~/code/guitool_ibeis/guitool_ibeis --separate
    make html
    ...
    Also:
        ...
        https://readthedocs.org/dashboard/guitool_ibeis/advanced/
        ...
        Will also need to activate the main branch:
            https://readthedocs.org/projects/guitool_ibeis/versions/
"""
#
...
htmlhelp_basename = 'guitool_ibeisdoc'
